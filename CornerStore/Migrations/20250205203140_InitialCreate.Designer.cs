...
namespace CornerStore.Migrations
{
    ...
    [Migration("20250205203140_InitialCreate")]
            ...
            modelBuilder.Entity("CornerStore.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CashierId = 1,
                            PaidOnDate = new DateTime(2024, 2, 5, 10, 30, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = 2,
                            CashierId = 2,
                            PaidOnDate = new DateTime(2024, 2, 5, 14, 45, 0, 0, DateTimeKind.Unspecified)
                        });
                });
